/**
 * The school's Smart Greenhouse system automatically records the air temperature 
 * every hour from 08:00 until 15:00. 
 * Instead of storing each temperature in a separate variable, the developer wants 
 * to store all temperature readings in a 
 * single collection so they can easily calculate the highest, lowest, and
 * average temperature later.
...
type dataTemperature = {
    Time: String;
    Temperature: number;
};

const temperatures: dataTemperature[] = [
